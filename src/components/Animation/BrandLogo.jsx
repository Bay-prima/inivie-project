 ...
 // Ref untuk setiap kotak
  ...
  return (
    <div className="relative flex w-full bg-blue-50 items-center justify-center">
        <a className="flex items-center justify-center uppercase rounded-lg z-40 w-36 bg-blue-50 "><img src="/public/assets/img/logo-inivie-ln.png" alt="" /></a>
      <div
        ref={box1Ref}
        style={{ ...boxStyle, }}
      >
        <img src="/public/assets/img/logo-member/1.webp" alt="" className="hover:scale-90 transition-all duration-500 ease-in-out" />
      </div>
      <div
        ref={box2Ref}
        style={{ ...boxStyle,  }}
      >
        <img src="/public/assets/img/logo-member/5.webp" alt="" className="hover:scale-90 transition-all duration-500 ease-in-out" />
      </div>
      <div
        ref={box3Ref}
        style={{ ...boxStyle,   }}
      >
        <img src="/public/assets/img/logo-member/3.webp" alt="" className="hover:scale-90 transition-all duration-500 ease-in-out" />
      </div>
      <div
        ref={box4Ref}
        style={{ ...boxStyle,   }}
      >
        <img src="/public/assets/img/logo-member/4.webp" alt="" className="hover:scale-90 transition-all duration-500 ease-in-out" />
      </div>
    </div>
  );
};
