...
const WebDiagram = () => {
    ...
    const benefits = [
        ...
        { iconName: "/public/assets/img/logo-member/1.webp", text: "PRIORITY VIP WELCOME", position: "top-[15%] lg:left-[20%]" },
        
        // Posisi Atas Tengah (Jam 12)
        { iconName: "/public/assets/img/logo-member/6.webp", text: "15% OFF AT WONDERSPACE OUTLETS", position: "top-7 left-1/2 -translate-x-1/2" },
        
        // Posisi Kanan Atas (Jam 1:30)
        { iconName: "/public/assets/img/logo-member/4.webp", text: "WELCOME AMENITY", position: "top-[15%] right-[20%] lg:right-[20%]" },

        // Posisi Kiri Tengah (Jam 9)
        { iconName: "/public/assets/img/logo-member/5.webp", text: "PREMIUM CUSTOMER CARE", position: "top-1/2 -translate-y-1/2 left-[15%]" },

        // Posisi Kanan Tengah (Jam 3)
        { iconName: "/public/assets/img/logo-member/3.webp", text: "EXCLUSIVE OFFERS", position: "top-1/2 -translate-y-1/2 right-[15%]" },

        // Posisi Kiri Bawah (Jam 7:30)
        { iconName: "/public/assets/img/logo-member/2.webp", text: "Welcome & Farewell Drinks", position: "bottom-[15%] lg:left-[20%]" },

        // Posisi Bawah Tengah (Jam 6)
        { iconName: "/public/assets/img/logo-member/8.webp", text: "FREE ACCESS TO BALI'S TOP CLUBS", position: "bottom-5 left-1/2 -translate-x-1/2" },
        
        // Posisi Kanan Bawah (Jam 4:30)
        { iconName: "/public/assets/img/logo-member/7.webp", text: "RELAXATION, ON US", position: "bottom-[15%]  lg:right-[20%]" },
    ];
        ...
        <div className="relative w-full max-w-[800px] h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div className="z-10 text-center">
                ...
                <div className="w-40 mx-auto mb-2 rounded-full flex items-center justify-center">
                    <img src="/public/assets/img/logo-inivie-ln.png" alt="" className='w-full h-full object-cover'/>
                </div>
            </div>
