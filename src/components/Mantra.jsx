    ...
    <section className="w-full relative px-12 my-28 flex items-center justify-center">
      <div className="grid lg:grid-cols-2 w-full gap-8 lg:gap-0 items-center max-w-[1500px] ">
        ...
        <div className="grid md:grid-cols-5 w-[100%] h-auto gap-4">
          ...
          <img src="/assets/img/experiences.webp" alt="mantra-img" loading="lazy" className="w-full h-full object-cover" />
          </div>  
        <div className="grid md:col-span-2 gap-4 md:grid-rows-2">
          <img src="/assets/img/experiences1.webp" alt="mantra-img" loading="lazy" className="w-full h-full object-cover" />
          <img src="/assets/img/experiences2.webp" alt="mantra-img" loading="lazy" className="w-full h-full object-cover" />
        </div>
        </div>
      </div>
    </section>
